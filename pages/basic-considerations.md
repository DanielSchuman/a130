...
## **Basic Considerations**
  ...
  d. Making information resources easy to find, accessible, and usable can fuel entrepreneurship, innovation, civic engagement, and scientific discovery that improves the lives of Americans.
  ...
  g. Information quality is a key parameter of information utility. Quality standards provide established means to evaluate rigor. Information quality should be commensure with its purpose. A lower level of information quality should not be used as an impediment to public release so long as the quality is appropriately described. 
  ...
  k. The Nation can benefit from Federal information disseminated by diverse non-Federal parties, including State and local government agencies, not-for profit institutions, educational institutions, civic developers, and for-profit organizations.
  ...
  m. Making datasets interoperable with other datasets--whether held inside the agency, by others in government, by civic developers, or the private sector--is a key way to maximize the value of a dataset. Accordingly, the use of unique identifiers, commonly-used identifiers, and cross-walks in the creation, update, and maintenance of datasets is strongly encouraged, as is the use of open data formats.
